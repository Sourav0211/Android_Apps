    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.buttonSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                data.put("gradeLetter" , selectedLetterGrade.getLetterGrade());
                data.put("gradeValue",selectedLetterGrade.getNumericGrade());
                data.put("courseId",selectedCourse.getCourseId());
                data.put("courseName",selectedCourse.getName());
                data.put("courseNumber",selectedCourse.getNumber());
                data.put("courseHours",selectedCourse.getHours());
                data.put("semesterName",selectedSemester.getName());
                data.put("semesterMonth",selectedSemester.getMonth());
                data.put("semesterYear",selectedSemester.getYear());
